...
st.markdown(
    ...
    .soon {font-family: 'Space+Grotesk', sans-serif; font-size: 3.2rem; font-weight: 700; color: #0f172a; margin: 1.4rem 0;}
    .box {padding: 1.4rem; border-radius: 16px; background: #ffffff; border: 1px solid #e2e8f0; box-shadow: 4px 6px 0 #0ea5e9;}
...
<div class="sub">All-in-one knowledge graph with GAN-powered link predictions. Coming soon.</div>
